...
{
	public class KCU : OpenQuant.API.Indicator
	{
		...
		public KCU(OpenQuant.API.Indicator indicator, int length)
		{
		...
		public KCU(OpenQuant.API.Indicator indicator, int length, Color color)
		{
