...
{
	public class PCU : OpenQuant.API.Indicator
	{
		...
		public PCU(OpenQuant.API.Indicator indicator, int length)
		{
		...
		public PCU(OpenQuant.API.Indicator indicator, int length, Color color)
		{
