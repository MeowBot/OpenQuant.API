...
{
	public class MFI : global::OpenQuant.API.Indicator
	{
		...
		public MFI(global::OpenQuant.API.Indicator indicator, int length)
		{
		...
		public MFI(global::OpenQuant.API.Indicator indicator, int length, Color color)
		{
