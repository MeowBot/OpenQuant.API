...
{
	public class OSC : OpenQuant.API.Indicator
	{
		...
		public OSC(OpenQuant.API.Indicator indicator, int length1, int length2)
		{
		...
		{
			this.indicator = new SmartQuant.Indicators.OSC(series.series, length1, length2, OpenQuant.API.EnumConverter.Convert(option));
		}
		public OSC(OpenQuant.API.Indicator indicator, int length1, int length2, BarData option)
		{
			this.indicator = new SmartQuant.Indicators.OSC(indicator.indicator, length1, length2, OpenQuant.API.EnumConverter.Convert(option));
		}
		...
		public OSC(OpenQuant.API.Indicator indicator, int length1, int length2, Color color)
		{
		...
		{
			this.indicator = new SmartQuant.Indicators.OSC(series.series, length1, length2, OpenQuant.API.EnumConverter.Convert(option), color);
		}
		public OSC(OpenQuant.API.Indicator indicator, int length1, int length2, BarData option, Color color)
		{
			this.indicator = new SmartQuant.Indicators.OSC(indicator.indicator, length1, length2, OpenQuant.API.EnumConverter.Convert(option), color);
		}
	}
}
