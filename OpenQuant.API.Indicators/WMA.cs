...
{
	public class WMA : global::OpenQuant.API.Indicator
	{
		...
		public WMA(global::OpenQuant.API.Indicator indicator, int length)
		{
		...
		{
			this.indicator = new SmartQuant.Indicators.WMA(series.series, length, global::OpenQuant.API.EnumConverter.Convert(option));
		}
		...
		public WMA(global::OpenQuant.API.Indicator indicator, int length, Color color)
		{
			this.indicator = new SmartQuant.Indicators.WMA(indicator.indicator, length);
		}
		public WMA(BarSeries series, int length, BarData option, Color color)
		{
			this.indicator = new SmartQuant.Indicators.WMA(series.series, length, global::OpenQuant.API.EnumConverter.Convert(option), color);
		}
	}
}
