...
{
	public class MarketFI : OpenQuant.API.Indicator
	{
		private MarketFI()
		{
		...
		public MarketFI(OpenQuant.API.Indicator indicator)
		{
		...
		public MarketFI(OpenQuant.API.Indicator indicator, Color color)
		{
