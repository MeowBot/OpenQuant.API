...
namespace OpenQuant.API.Quant
{
	public class FinMath
	{
		...
		{
			return SmartQuant.Quant.FinMath.Call(S, X);
		}
		public static double Put(double S, double X)
		{
			return SmartQuant.Quant.FinMath.Put(S, X);
		}
		...
		{
			return SmartQuant.Quant.FinMath.Vega(S, X, t, s, r);
		}
		...
		{
			return SmartQuant.Quant.FinMath.ImpliedVolatility(S, X, t, r, P, FinMath.SOptionType(OptionType), FinMath.SPutCall(PutCall), FinMath.SOptionPrice(Method), n, Eps);
		}
		...
		{
			return SmartQuant.Quant.FinMath.FuturesPrice(S, t, r);
		}
		public static double FuturesPrice(double S, double t, double r, double I)
		{
			return SmartQuant.Quant.FinMath.FuturesPrice(S, t, r, I);
		}
		public static double Min(double Value1, double Value2, double Value3)
		{
			return SmartQuant.Quant.FinMath.Min(Value1, Value2, Value3);
		}
		public static double Max(double Value1, double Value2, double Value3)
		{
			return SmartQuant.Quant.FinMath.Max(Value1, Value2, Value3);
		}
		...
		{
			return SmartQuant.Quant.FinMath.Min(DateTime1, DateTime2);
		}
		public static DateTime Max(DateTime DateTime1, DateTime DateTime2)
		{
			return SmartQuant.Quant.FinMath.Max(DateTime1, DateTime2);
		}
		public static DateTime Min(DateTime DateTime1, DateTime DateTime2, DateTime DateTime3)
		{
			return SmartQuant.Quant.FinMath.Min(DateTime1, DateTime2, DateTime3);
		}
		public static DateTime Max(DateTime DateTime1, DateTime DateTime2, DateTime DateTime3)
		{
			return SmartQuant.Quant.FinMath.Max(DateTime1, DateTime2, DateTime3);
		}
		public static double Percentile(double Level, double[] Data)
		{
			return SmartQuant.Quant.FinMath.Percentile(Level, Data);
		}
		public static int BinarySearch(int n, double[] SearchArray, double SearchValue)
		{
			return SmartQuant.Quant.FinMath.BinarySearch(n, SearchArray, SearchValue);
		}
		...
		{
			return SmartQuant.Quant.FinMath.Distance(X1, Y1, X2, Y2);
		}
		public static double Distance(double X1, double Y1, double Z1, double X2, double Y2, double Z2)
		{
			return SmartQuant.Quant.FinMath.Distance(X1, Y1, Z1, X2, Y2, Z2);
		}
		public static double Percent(double P, double Base)
		{
			return SmartQuant.Quant.FinMath.Percent(P, Base);
		}
		public static int GetNDays(DateTime Date1, DateTime Date2)
		{
			return SmartQuant.Quant.FinMath.GetNDays(Date1, Date2);
		}
	}
}
