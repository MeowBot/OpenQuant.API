...
namespace OpenQuant.API
{
	public class TimeSeries : ISeries
	{
		...
		[Category("Drawing"), Description("Gets or sets series width")]
		public int Width
		{
			get
			{
		...
		public TimeSeries(string name, string title, Color color) : this(name, title)
		{
		...
		public TimeSeries(string name, Color color) : this(name, "", color)
		{
		}
		...
		{
			return this.series.CrossesBelow(series.series, bar.bar, (int)barData);
		}
		...
		{
			return this.series.CrossesBelow(indicator.indicator, dateTime);
		}
